...
public class ServletModificaEnteET extends HttpServlet 
{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
        ...
        {
        	throw new IllegalArgumentException("Il campo Descrizione delle Attivit� supera la lunghezza consentita");
        }
         ...
         */
		EnteConvenzionato enteCon = new EnteConvenzionato(email,name,
				null, ' ', "123456",
		...
		try 
		{
			...
			{ 
				...
				RequestDispatcher dispatcher = request.getRequestDispatcher("ModificaEnteET.jsp"); //Controlla jsp
