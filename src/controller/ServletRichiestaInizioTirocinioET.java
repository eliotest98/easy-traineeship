    ...
    if (request.getParameter("matricolaTirocinante") != null) {
      if (tirocinanteDao.ricercaTirocinanteByMatricola(
        ...
        if (tirocinante.getCittadinanza().length() > 64) {
          throw new IllegalArgumentException(
              "Il campo 'Cittadinanza' supera la lunghezza consentita");
        }
        ...
        if (tirocinante.getCodiceFiscale() == null
            || tirocinante.getCodiceFiscale().length() == 0) {
        ...
        if (tirocinio.getCompetenze().length() > 256) {
          throw new IllegalArgumentException(
              "Il campo 'Competenze' supera la lunghezza consentita");
        }
        ...
        if (tirocinio.getAttivitaPreviste() == null
            || tirocinio.getAttivitaPreviste().length() == 0) {
        ...
        // Mi vado a riprendere il tirocinio e il tirocinante appena creati e li metto nella
        // sessione
        tirocinio = ti.tirocinioAttivo(Long.valueOf(request.getParameter("matricolaTirocinante")));
        tirocinante = t.ricercaTirocinanteByMatricola(
            Long.valueOf(request.getParameter("matricolaTirocinante")));
