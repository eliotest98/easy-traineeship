...
public class ServletRegistrazioneEnteET extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		 ...
		 */
		EnteConvenzionato enteCon = new EnteConvenzionato(email, name, "NA", 'N', "123456", 3, dataDiNascita,
				partitaIva, sede, rappresentante, referente, telefono, Integer.parseInt(dipendenti), dotRiferimento,
				"TE", descrizioneAttivita);
		/**
		 * Inserimento nel DB.
		 */
		try {
