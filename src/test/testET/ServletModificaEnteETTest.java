...
class ServletModificaEnteETTest {
  ...
  public void setUp() {
    ...
    try {
      ...
      String sql4 =
          ("INSERT INTO User VALUES('greentech@gmail.com','Tester','Amendola','M','salvo','0');");
      stmtSelect.executeUpdate(sql4);
      String sql3 =
          ("INSERT INTO enteconvenzionato VALUES('12312312312',"
              + "'Avellino','Salvatore Totti','0825519149','100',"
              + "'Michele Persico','Michele Porto','08/01/1977',"
              + "'esperti in siti web','greentech@gmail.com');");
  ...
  void testCampoProfessorediRiferimentoTroppoLungo() {
    ...
    IllegalArgumentException e =
        assertThrows(IllegalArgumentException.class, () -> test.doPost(requestMock, responseMock));
    assertEquals("Il campo 'Professore di Riferimento' supera la lunghezza consentita",
        e.getMessage());
  }
  ...
  void testCampoDescrizioneAttivitaTroppoLungo() {
    ...
    IllegalArgumentException e =
        assertThrows(IllegalArgumentException.class, () -> test.doPost(requestMock, responseMock));
    assertEquals("Il campo 'Descrizione delle Attivit&agrave' supera la lunghezza consentita",
        e.getMessage());
  }
  ...
  void testCampoPartitaIvaFormatoErrato() {
    ...
    when(requestMock.getParameter("descrizioneAttivita"))
        .thenReturn("L’ampia esperienza maturata e le capacità progettuali "
            + "sono gli strumenti che mettiamo a disposizione delle  "
            + "aziende nostre clienti per aumentarne la "
            + "produttività e l’efficienza interna, e per migliorarne "
            + "sensibilmente il rapporto con la propria clientela");
