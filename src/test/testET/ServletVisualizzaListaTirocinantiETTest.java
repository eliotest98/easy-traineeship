...
class ServletVisualizzaListaTirocinantiETTest {
  ...
  ServletVisualizzaListaTirocinantiET servletSecretaryMock =
      mock(ServletVisualizzaListaTirocinantiET.class);
  ...
  void testReindirizzamentoVisualizzaListaTirocinanti() throws ServletException, IOException {
    when(requestMock.getRequestDispatcher("/_areaSecretary/VisualizzaListaTirocinantiET.jsp"))
