...
class ServletGestioneRichiesteSegreteriaETTest {
  ...
  ServletGestioneRichiesteSegreteriaET servletSecretaryMock =
      mock(ServletGestioneRichiesteSegreteriaET.class);
  ...
  void testReindirizzamento() throws ServletException, IOException {
    when(requestMock.getRequestDispatcher("_areaSecretary/VisualizzaRichiestaET.jsp"))
