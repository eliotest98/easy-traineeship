...
class ServletStatoTirocinanteETTest {
  ...
  Student user =
      new Student("t.tester@studenti.unisa.it", "Tester", "Serritiello", 'M', "password", 0);
  ...
  String sql5 = ("INSERT INTO tirocinio VALUES('999','" + new Date(0)
      ...
      + "'In attesa dell Ente','progettoformativa.pdf',"
  ...
  void testStatoProprioTirocinioET() throws ServletException, IOException {
    ...
    when(requestMock.getRequestDispatcher("/_areaStudent/StatoProprioTirocinioET.jsp"))
