...
class ServletStatoTirocinanteETTest {
	...
	Student user = new Student("t.tester@studenti.unisa.it","Tester","Serritiello",'M',"password",0);
	TirocinanteDAO tirocinanteDao = new TirocinanteDAO();
	
	String sql1 = ("INSERT INTO User VALUES('t.tester@studenti.unisa.it','Pellegrino','Aurilia','M','pelle','0');");
	...
	String sql5 = ("INSERT INTO tirocinio VALUES('999','"+new Date(0)+"','11','informatica','javascript','Java','Bene','In attesa dell Ente','progettoformativa.pdf','ragazzo valido','4859','11111111111');");
	...
	@Test
	void testStatoProprioTirocinioET() throws ServletException, IOException {
		when(requestMock.getParameter("pagina")).thenReturn("StatoProprioTirocinioET");
		when(requestMock.getRequestDispatcher("/_areaStudent/StatoProprioTirocinioET.jsp")).thenReturn(dispatcherMock);
		test.doPost(requestMock, responseMock);
		verify(dispatcherMock).forward(requestMock, responseMock);
	}
	
	@Test
	void testStoricoStudenteET() throws ServletException, IOException {
		when(requestMock.getParameter("pagina")).thenReturn("StoricoStudenteET");
