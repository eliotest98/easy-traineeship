...
class ServletStatoTirocinioETTest {
  ...
  void setUp() {
    ...
    when(requestMock.getRequestDispatcher("/_areaSecretary/VisualizzaStatoTirocinioET.jsp"))
  ...
  void testReindirizzamentoSenzaEnte() throws ServletException, IOException {
    ...
    try {
      ...
      String sql5 = ("INSERT INTO tirocinio VALUES('999','" + new Date(0)
          ...
          + "'In attesa Ente','progettoformativa.pdf','ragazzo valido','4859',"
          + tirocinio.getPartitaIva() + ");");
      stmtSelect.executeUpdate(sql5);
      conn.commit();
    } catch (Exception e) {
      e.printStackTrace();
  ...
  void testReindirizzamentoConEnte() throws ServletException, IOException {
    ...
    try {
      ...
      String sql5 = ("INSERT INTO tirocinio VALUES('999','" + new Date(0)
          + "','11','informatica','javascript','Java','Bene',"
          + "'In attesa Ente','progettoformativa.pdf','ragazzo valido','4859','11111111111');");
      stmtSelect.executeUpdate(sql5);
      conn.commit();
    } catch (Exception e) {
      e.printStackTrace();
