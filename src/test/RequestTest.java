...
class RequestTest {
	...
	void testGetIdRequest() {
		...
		Request req = new Request(1, 0, "", rd, ed, 0, 111, Year.of(0), new ArrayList<Attached>(), new State(0, ""),
				new Ente(0, "", "", ""), ui);
	...
	void testGetYear() {
		...
		Request req = new Request(1, 0, "", rd, ed, 0, 111, Year.of(2010), new ArrayList<Attached>(), new State(0, ""),
				new Ente(0, "", "", ""), ui);
	...
	void testGetState() {
		...
		Request req = new Request(1, 0, "", rd, ed, 0, 111, Year.of(0), attached, state, new Ente(0, "", "", ""), ui);
