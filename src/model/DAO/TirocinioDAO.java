...
public class TirocinioDAO {
  ...
  public synchronized ArrayList allTirocinio() {
    ...
    try {
      ...
      ps = con
          .prepareStatement("SELECT * " + "FROM TIROCINIO, TIROCINANTE, USER, ENTECONVENZIONATO "
  ...
  /**
   * Metodo che interroga il DB e restituisce i tirocini attivi di uno studente.
   * 
   * @param matricola
   * 
   * @return listaTirocini
  ...
  public synchronized Tirocinio tirocinioAttivo(long matricola) {
    ...
    try {
      ...
      con = new DbConnection().getInstance().getConn();
      // Query Sql per prelevare i Tirocini
      ps = con.prepareStatement("SELECT * " + "FROM TIROCINIO, TIROCINANTE, USER "
          + "WHERE TIROCINIO.MATRICOLA=TIROCINANTE.MATRICOLA && "
          + "TIROCINANTE.EMAIL=USER.EMAIL && " + "TIROCINIO.STATOTIROCINIO!='Annullato' && "
          + "TIROCINIO.STATOTIROCINIO!='Rifiutato' && " + "TIROCINANTE.MATRICOLA='" + matricola
          + "'; ");
      ResultSet res = ps.executeQuery();
      // Ciclo che inserisce all' interno della lista i 'Tirocini'
      // restituiti dalla query
  ...
  /**
   * Metodo che interroga il DB e restituisce tutti i 'Tirocini' persenti all' interno in base allo
   * stato di 'STATOTIROCINIO' per Segreteria e Admin e EnteConvenzionato.
   * 
  ...
  public synchronized ArrayList allTirocinioByStato(String statoTirocinio) {
    ...
    try {
      ...
      ps = con.prepareStatement("SELECT * " + "FROM TIROCINIO, TIROCINANTE, USER "
          + "WHERE TIROCINIO.MATRICOLA=TIROCINANTE.MATRICOLA && "
          + "TIROCINANTE.EMAIL=USER.EMAIL && " + "TIROCINIO.STATOTIROCINIO='" + statoTirocinio
          + "';");
      ResultSet res = ps.executeQuery();
      // Ciclo che inserisce all' interno della lista i 'Tirocini'
      // restituiti dalla query
  ...
  /**
   * Metodo che interroga il DB e restituisce tutti i 'Tirocini' persenti all' interno di un
   * enteConvenzionato.
   * 
   * @param email
   * 
  ...
  public synchronized ArrayList allTirocinioTirocinante(long matricola) {
    ...
    try {
      ...
      // Query Sql per prelevare i Tirocini
      ps = con
          .prepareStatement("SELECT * " + "FROM TIROCINIO " + "WHERE MATRICOLA=" + matricola + ";");
      ResultSet res = ps.executeQuery();
      // Ciclo che inserisce all' interno della lista i 'Tirocini'
      // restituiti dalla query
      while (res.next()) {
  ...
  /**
   * Metodo che interroga il DB e restituisce i tirocini di uno studente da firmare.
   * 
   * @param email
   * 
   * @param stato
  ...
  public synchronized Tirocinio allTirocinioByDocumento(String email, String stato) {
    ...
    try {
      ...
      con = new DbConnection().getInstance().getConn();
      // Query Sql per prelevare i Tirocini
      psView = con.prepareStatement(
          "create view viewEnte as " + "select email, name as NomeEnte " + "from user; ");


      ps = con.prepareStatement(
          "SELECT * " + "FROM TIROCINIO, TIROCINANTE, USER, ENTECONVENZIONATO, viewEnte "
              + "WHERE TIROCINIO.MATRICOLA=TIROCINANTE.MATRICOLA && "
              + "TIROCINANTE.EMAIL=USER.EMAIL && "
              + "TIROCINIO.PARTITAIVA=ENTECONVENZIONATO.PARTITAIVA && "
              + "viewEnte.email=ENTECONVENZIONATO.EMAIL && " + "TIROCINIO.STATOTIROCINIO='" + stato
              + "' && " + "USER.EMAIL='" + email + "'; ");
  ...
  /**
   * Metodo che interagisce con il DB e inserisce in esso il 'Tirocinio' passato come parametro.
   * I dati inseriti sono: DATAINIZIOTIROCINO, CFUPREVISTI, COMPETENZE, COMPETENZEACQUISIRE,
  ...
  public synchronized boolean inserisciTirocinio(Tirocinio tirocinio) {
    ...
    try {
      ...
      psTirocinio = con
          .prepareStatement("INSERT INTO TIROCINIO(CODTIROCINIO,DATAINIZIOTIROCINO, CFUPREVISTI, "
   ...
   * @return boolean
   */
  public synchronized boolean richiestaEnte(int codTirocinio, String partitaIva,
    ...
    try {
      ...
      psTirocinio = con.prepareStatement(
          "UPDATE TIROCINIO SET DESCRIZIONEENTE='" + descrizioneEnte + "', " + "PARTITAIVA ='"
              + partitaIva + "' " + "WHERE CODTIROCINIO ='" + codTirocinio + "'; ");
  ...
  /**
   * Metodo che interagisce con il DB e modifica lo stato 'STATOTIROCNIO' del 'Tirocinio' passato
   * come parametro.
   * 
   * @param codTirocinio
   * 
  ...
  /**
   * Metodo che interagisce con il DB e carica il nome del Progetto Formativo.
   * 
   * @param codTirocinio
   * 
  ...
  public synchronized boolean uploadProgettoFormativo(int codTirocinio, String progettoFormativo) {
    ...
    try {
      ...
      psTirocinio = con.prepareStatement("UPDATE TIROCINIO " + "SET PROGETTOFORMATIVO ='"
          + progettoFormativo + "' " + "WHERE CODTIROCINIO ='" + codTirocinio + "'; ");
      // Se la modifica va a buon fine restituisce true
      if (psTirocinio.executeUpdate() == 1) {
        con.commit();
        return true;
  ...
  /**
   * Metodo che interagisce con il DB e restituisce il path del 'PROGETTOFORMATIVO'.
   * 
   * @param codTirocinio
   * 
  ...
  public synchronized String downloadProgettoFormativo(int codTirocinio) {
    ...
    try {
      ...
      ps = con.prepareStatement("SELECT PROGETTOFORMATIVO " + "FROM TIROCINIO "
          + "WHERE CODTIROCINIO=" + codTirocinio + ";");
      ResultSet res = ps.executeQuery();
      // Ciclo che inserisce all' interno della lista i 'Tirocini'
      // restituiti dalla query
  ...
  /**
   * Metodo che interroga il DB e restituisce tutti i 'Tirocini' persenti all' interno per uno
   * Studente, utile per ricercare tutti i documenti da cercare.
   * 
   * @param matricola
   * 
   * @param  statoTirocinio
   ...
   * @return listaTirocini
   */
  public synchronized ArrayList allDocumentiDaFirmareByStudente(int matricola,
  ...
  /**
   * Metodo che interroga il DB e restituisce tutti i 'Tirocini' persenti all' interno per un
   * EnteConvenzionato, utile per ricercare tutti i documenti da cercare.
   * 
   * @param partitaIva
   * 
   * @param statoTirocinio
   ...
   * @return listaTirocini
   */
  public synchronized ArrayList allDocumentiDaFirmareByEnte(String partitaIva,
      String statoTirocinio) {
  ...
  /**
   * Metodo che interroga il DB e restituisce il tirocinio in base al codice.
   * 
   * @param codTirocinio
   * 
   * @return tirocinio
   */
  public synchronized Tirocinio TirocinioByCodTirocinio(int codTirocinio) {
    Tirocinio tirocinio = null;
    Connection con = null; // variabile per la connesione del DB
    PreparedStatement ps = null;// Creazione oggetto Statement
    ...
    try {
      ...
      ps = con.prepareStatement("SELECT * " + "FROM TIROCINIO, TIROCINANTE, USER "
          + "WHERE TIROCINIO.MATRICOLA=TIROCINANTE.MATRICOLA && "
          + "TIROCINANTE.EMAIL=USER.EMAIL && " + "TIROCINIO.CODTIROCINIO=" + codTirocinio + "; ");
      ResultSet res = ps.executeQuery();
      // Ciclo che inserisce all' interno della lista i 'Tirocini'
      // restituiti dalla query
      while (res.next()) {
  ...
  /**
   * Metodo che interroga il DB e modifica il tirocinio in base al codice.
   * 
   * @param codTirocinio
   * 
   * @return boolean
   */
  public synchronized boolean modificaDescrizioneEnteTirocinio(int codTirocinio,
      String descrizioneEnte) {
