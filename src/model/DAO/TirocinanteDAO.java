	...
	public boolean inserisciTirocinante(Tirocinante tirocinante) {
		...
		try {
			...
			psUser = con.prepareStatement(
					"INSERT INTO USER(EMAIL, NAME, SURNAME, SEX, PASSWORD, USER_TYPE) " + "VALUES (?, ?, ?, ?, ?, 0)");
			...
			psTirocinante = con.prepareStatement("INSERT INTO TIROCINANTE(MATRICOLA, DATANASCITA, LUOGONASCITA,"
