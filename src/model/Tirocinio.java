 ...
 * Class.
 *
 * Questa classe va a rappresentare l'oggetto Tirocinio che nel seguente dominio
 * applicativo raffigura il "Progetto Formativo" del tirocinante.
 */
public class Tirocinio {
	 ...
	 * @param descrizioneEnte      descrizione del Tirocinio dello 'Studente' all
	 *                             'EnteConvenzionato'
	 * @param matricola            dello 'Studente' associato
	 * @param partitaIva           dell' 'EnteConvenzionato' associato
	 * 
	 */
	public Tirocinio(int codTirocinio, String dataInizioTirocinio, short cfuPrevisti, String competenze,
			String competenzeAcquisire, String attivitaPreviste, String svolgimentoTirocinio, String statoTirocinio,
			String progettoFormativo, String descrizioneEnte, int matricola, String partitaIva) {
