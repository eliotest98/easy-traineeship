...
/**
 * Class.
 * Questa classe va a rappresentare l'oggetto Tirocinio che nel seguente dominio applicativo
 * raffigura il "Progetto Formativo" del tirocinante.
 */
public class Tirocinio {
   ...
   * 
   */
  public Tirocinio(int codTirocinio, String dataInizioTirocinio, short cfuPrevisti,
      String competenze, String competenzeAcquisire, String attivitaPreviste,
      String svolgimentoTirocinio, String statoTirocinio, String progettoFormativo,
      String descrizioneEnte, long matricola, String partitaIva) {
