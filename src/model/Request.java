...
public class Request {
	...
	/**
	 * idRequest requestCfu level releaseDate expireDate validatedCfu serial year
	 * attached state ente user Return Request.
	 */

	public Request(int idRequest, int requestCfu, String level, GregorianCalendar releaseDate,
			GregorianCalendar expireDate, int validatedCfu, int serial, Year year, List<Attached> attached, State state,
			Ente ente, UserInterface user) {
