...
public class EnteConvenzionato implements UserInterface {
	 ...
	 */
	public EnteConvenzionato(String email, String name, String surname, char sex, String password, int userType,
			String dataDiNascita, String partitaIva, String sede, String rappresentante, String referente,
			String telefono, int dipendenti, String dotRiferimento, String tipoTirocinio, String descrizioneAttivita) {
		super();
		this.email = email;
		this.name = name;
