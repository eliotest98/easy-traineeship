													...
													if(Segreteria!=null)
													{
														...
														<td class="text-center" align="center">
															...
															<form id="signUp" action="./ServletEliminaEnteET" method="post">
																<button type="submit" class="btn btn-primary btn-action eliminaEnte refuse" style="background:#e73f43; border:#e73f43" data-type="2" data-idrequest="35" title="Elimina Ente" ><i class="fa fa-times"></i></button>
															</form>
														</td>
														<%
													}
