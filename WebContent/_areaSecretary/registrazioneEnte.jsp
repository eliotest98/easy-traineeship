...
<%
    String pageName = "registrazioneEnte.jsp";
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 signUp-container">
                                ...
                                <form id="signUp" action="/ServletRegistazioneEnteET" method="post">
                                    ...
                                    <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        ...
                                        <input type="text" class="form-control"
                                               placeholder="Descrizione delle Attività" minlength="1" maxlength="64" name="descrizioneAttivita" id="descrizioneAttivita" required>
                                    </div>
                                    <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
